...
const Dio_ConfigType Dio_Configuration =
                                   {
									...
									{DioConf_SPI_CS0_PORT_NUM, DioConf_SPI_CS0_CHANNEL_NUM},
									{DioConf_SPI_CS1_PORT_NUM, DioConf_SPI_CS1_CHANNEL_NUM},
									{DioConf_SPI_CS2_PORT_NUM, DioConf_SPI_CS2_CHANNEL_NUM},
									{DioConf_SPI_CS3_PORT_NUM, DioConf_SPI_CS3_CHANNEL_NUM},
									{DioConf_SPI_CS4_PORT_NUM, DioConf_SPI_CS4_CHANNEL_NUM},
									{DioConf_SPI_CS5_PORT_NUM, DioConf_SPI_CS5_CHANNEL_NUM},
									{DioConf_SPI_CS6_PORT_NUM, DioConf_SPI_CS6_CHANNEL_NUM}
									},
									{
